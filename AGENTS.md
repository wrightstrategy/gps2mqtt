...
<!-- ws:dev source=wrightstrategy/bridge:conventions/dev.md version=1 sha256=741eb2d55b11e8c0e4c60135104368327f4607c7883d3eae365119611625924a -->
# Coding Universe
...
- **Binding — Work management:** use Linear (`ws-dev:linear`): planned work → Backlog,
  discoveries → Triage; never promote your own finding. Only bugs get priority.
  Follow the skill's routing, labels, evidence and blocked-on-it rules. Platform requests
  use PLT + `ws-dev:repo-request`. Never file agent work in GitHub; link PRs to Linear.
...
This repo is: GPSD location telemetry publisher for MQTT and Traccar.
